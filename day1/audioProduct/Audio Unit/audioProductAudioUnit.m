//
//  audioProductAudioUnit.m
//  audioProduct
//
//  Created by Raghav Deo on 16/06/22.
//

#import "audioProductAudioUnit.h"
...
@interface audioProductAudioUnit ()
...
@implementation audioProductAudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[audioProductDSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block audioProductDSPKernelAdapter * kernelAdapter = _kernelAdapter;
